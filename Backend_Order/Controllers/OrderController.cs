...
namespace Backend_Order.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<JsonResult> GetAll(string supplierId)
        {
            return new JsonResult(await orderService.GetAllOrders(supplierId));
        }
        ...
        {
            return new JsonResult(await orderService.GetOrderById(id));
        }
